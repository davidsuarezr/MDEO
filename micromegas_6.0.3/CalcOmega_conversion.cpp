...
{  
		...
		ForceUG=1; 
            ...
            if(Tefo < Tstart)
            {
            kk1 = vs1122F(Tefo); printf("Sigmav1122=%.4E\n",kk1);
			kk2 = vs1100F(Tefo); printf("Sigmav1100=%.4E\n",kk2);    
            kk3 = vs2211F(Tefo); printf("Sigmav2211=%.4E\n",kk3);
			kk4 = vs2200F(Tefo); printf("Sigmav2200=%.4E\n",kk4);   
            }
			else
            {    
			//kk = vSigmaN(0.001,"1122");
			kk1 = vs1122F(Tstart); printf("Sigmav1122=%.3E\n",kk1);
			kk2 = vs1100F(Tstart); printf("Sigmav1100=%.3E\n",kk2);
            kk3 = vs2211F(Tstart); printf("Sigmav2211=%.3E\n",kk3);
			kk4 = vs2200F(Tstart); printf("Sigmav2200=%.3E\n",kk4); 
            }    
