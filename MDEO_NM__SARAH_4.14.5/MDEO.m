...
ScalarFields[[2]] = {bi, 1,       BiD,    0, 1, 1, -9,  1,  1};
ScalarFields[[3]] = {Et, 1, {et0,etm}, -1/2, 2, 1,  1,  1, -1};
...
LagBSMNoHC = -(- MuP conj[bi].bi + 1/2 L2 conj[bi].bi.conj[bi].bi + L3 conj[bi].bi.conj[H].H + mEt2  conj[Et].Et - L4 conj[Et].Et.conj[Et].Et - L5 conj[H].H.conj[Et].Et - L6 conj[bi].bi.conj[Et].Et + MS2 conj[S].S - LamSH conj[S].S.conj[H].H  - LamS conj[S].S.conj[S].S   - L7 conj[S].S.conj[bi].bi  - L8 conj[Et].Et.conj[S].S);

LagBSMHC = - yc bi.CL.CR - yx bi.FxL.FxR - y1 l.conj[Et].conj[FxR] - y2 FxL.S.v - lc conj[H].Et.S;
