...
def buildSLHAinFile():
    ...
    LHA.blocks['MINPAR'].entries[1]='2.400000E-01          # lambda1Input'
    LHA.blocks['MINPAR'].entries[2]='0.0015000135046724    # lambda2Input'
    LHA.blocks['MINPAR'].entries[3]='0.281055343094922     # lambda3Input'
    LHA.blocks['MINPAR'].entries[4]='0.267022133489987     # lambda4Input'
    LHA.blocks['MINPAR'].entries[5]='4.09853616608218      # lambda5Input'
    LHA.blocks['MINPAR'].entries[6]='9.9348547276404E-05   # lambda6Input'
    LHA.blocks['MINPAR'].entries[7]='0.0067437101688459    # lambda7Input'
    LHA.blocks['MINPAR'].entries[8]='0.679826877026957     # lambda8Input'
    LHA.blocks['MINPAR'].entries[9]='0.006155532737543     # lambda9Input'
    LHA.blocks['MINPAR'].entries[10]='0.571637148509978    # lambda10Input'
    LHA.blocks['MINPAR'].entries[11]='0.544542403378008    # lambda11Input'
    LHA.blocks['MINPAR'].entries[20]='0.0240215110504602   # g1pINPUT'
    LHA.blocks['MINPAR'].entries[21]='0.000000E+00         # g1p1INPUT'
    LHA.blocks['MINPAR'].entries[22]='-2.6462421198E-07    # g11pINPUT'
    LHA.blocks['MINPAR'].entries[23]='5803801.06507612     # mEt2Input'
    LHA.blocks['MINPAR'].entries[24]='65916668.9304105     # MS2Input'
    LHA.blocks['MINPAR'].entries[30]='189.326587146094     # vXinput'
    LHA.blocks['MINPAR'].entries[31]='0.758005819705211    # Ycinput'
    LHA.blocks['MINPAR'].entries[32]='172.937987333794     # muCinput'
    ...
    #Block YNLIN    #  
    LHA.blocks['YNLIN'].entries[1,1]='   0.000000E-04         # YnL(1,1)'
    LHA.blocks['YNLIN'].entries[1,2]='   0.00681971017964     # YnL(1,2)'
    LHA.blocks['YNLIN'].entries[1,3]='   0.26695195961994     # YnL(1,3)'
    LHA.blocks['YNLIN'].entries[2,1]='   0.000000E-06         # YnL(2,1)'
    LHA.blocks['YNLIN'].entries[2,2]='   0.67168357658654     # YnL(2,2)'
    LHA.blocks['YNLIN'].entries[2,3]='   0.06592339104346     # YnL(2,3)'

    #Block YNRIN    #  
    LHA.blocks['YNRIN'].entries[1,1]='   -3.34124806845828E-08        # YnR(1,1)'
    LHA.blocks['YNRIN'].entries[1,2]='   -1.86847348281352E-07        # YnR(1,2)'
    LHA.blocks['YNRIN'].entries[1,3]='   -1.66097127120509E-07        # YnR(1,3)'
    LHA.blocks['YNRIN'].entries[2,1]='   -9.95036060875316E-09        # YnR(2,1)'
    LHA.blocks['YNRIN'].entries[2,2]='   -5.83402037382186E-09        # YnR(2,2)'
    LHA.blocks['YNRIN'].entries[2,3]='   1.28109337786455E-08         # YnR(2,3)'
 
    #Block YXIN    #  
    LHA.blocks['YXIN'].entries[1,1]='   1.03662274906008         # YX(1,1)'
    LHA.blocks['YXIN'].entries[1,2]='   -0.0090450672932         # YX(1,2)'
    LHA.blocks['YXIN'].entries[2,1]='   -0.0090450672932         # YX(2,1)'
    LHA.blocks['YXIN'].entries[2,2]='   1.05953088031988         # YX(2,2)'
    ################################################################
