...
def buildSLHAinFile():
    ...
    LHA.blocks['MINPAR'].entries[3]='3.000000E-02    # lambda3Input'
    LHA.blocks['MINPAR'].entries[4]='4.000000E-02    # lambda4Input'
    LHA.blocks['MINPAR'].entries[5]='3.000000E-03    # lambda5Input'
    LHA.blocks['MINPAR'].entries[6]='2.000000E-03    # lambda6Input'
    LHA.blocks['MINPAR'].entries[7]='3.000000E-02    # lambda7Input'
    LHA.blocks['MINPAR'].entries[8]='3.000000E-03    # lambda8Input'
    LHA.blocks['MINPAR'].entries[9]='3.000000E-02    # lambda9Input'
    LHA.blocks['MINPAR'].entries[10]='1.000000E-02    # lambda10Input'
    LHA.blocks['MINPAR'].entries[11]='2.000000E-02    # lambda11Input'
    ...
    LHA.blocks['MINPAR'].entries[23]='4.000000E+08    # mEt2Input'
    LHA.blocks['MINPAR'].entries[24]='4.000000E+08    # MS2Input'
    LHA.blocks['MINPAR'].entries[30]='5.000000E+03    # vXinput'
    LHA.blocks['MINPAR'].entries[31]='2.000000E-01    # Ycinput'
    LHA.blocks['MINPAR'].entries[32]='4.000000E+02    # muCinput'
    ...
    #Block YNLIN    #  
    LHA.blocks['YNLIN'].entries[1,1]='   1.000000E-04         # YnL(1,1)'
    LHA.blocks['YNLIN'].entries[1,2]='   2.000000E-05         # YnL(1,2)'
    LHA.blocks['YNLIN'].entries[1,3]='   1.000000E-04         # YnL(1,3)'
    LHA.blocks['YNLIN'].entries[2,1]='   2.000000E-06         # YnL(2,1)'
    LHA.blocks['YNLIN'].entries[2,2]='   3.000000E-04         # YnL(2,2)'
    LHA.blocks['YNLIN'].entries[2,3]='   2.000000E-06         # YnL(2,3)'

    #Block YNRIN    #  
    LHA.blocks['YNRIN'].entries[1,1]='   1.000000E-01         # YnR(1,1)'
    LHA.blocks['YNRIN'].entries[1,2]='   2.000000E-04         # YnR(1,2)'
    LHA.blocks['YNRIN'].entries[1,3]='   1.000000E-05         # YnR(1,3)'
    LHA.blocks['YNRIN'].entries[2,1]='   2.000000E-03         # YnR(2,1)'
    LHA.blocks['YNRIN'].entries[2,2]='   3.000000E-04         # YnR(2,2)'
    LHA.blocks['YNRIN'].entries[2,3]='   1.000000E-03         # YnR(2,3)'
