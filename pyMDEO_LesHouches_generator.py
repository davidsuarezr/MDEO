...
def buildSLHAinFile():
    ...
    LHA.blocks['MINPAR'].entries[5]='3.000000E-02    # lambda5Input'
    ...
    LHA.blocks['MINPAR'].entries[23]='4.000000E+07    # mEt2Input'
    LHA.blocks['MINPAR'].entries[24]='4.000000E+07    # MS2Input'
    LHA.blocks['MINPAR'].entries[30]='4.000000E+03    # vXinput'
    LHA.blocks['MINPAR'].entries[31]='1.000000E-01    # Ycinput'
    ...
    #Block YNLIN    #  
    LHA.blocks['YNLIN'].entries[1,1]='   1.000000E-03         # YnL(1,1)'
    LHA.blocks['YNLIN'].entries[1,2]='   2.000000E-03         # YnL(1,2)'
    LHA.blocks['YNLIN'].entries[1,3]='   1.000000E-02         # YnL(1,3)'
    LHA.blocks['YNLIN'].entries[2,1]='   2.000000E-03         # YnL(2,1)'
    LHA.blocks['YNLIN'].entries[2,2]='   3.000000E-03         # YnL(2,2)'
    LHA.blocks['YNLIN'].entries[2,3]='   2.000000E-02         # YnL(2,3)'

    #Block YNRIN    #  
    LHA.blocks['YNRIN'].entries[1,1]='   1.000000E-03         # YnR(1,1)'
    LHA.blocks['YNRIN'].entries[1,2]='   2.000000E-02         # YnR(1,2)'
    LHA.blocks['YNRIN'].entries[1,3]='   1.000000E-02         # YnR(1,3)'
    LHA.blocks['YNRIN'].entries[2,1]='   2.000000E-04         # YnR(2,1)'
    ...
    LHA.blocks['YXIN'].entries[1,2]='   2.000000E-03         # YX(1,2)'
